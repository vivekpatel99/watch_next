...
class MockApiService extends _i1.Mock implements _i8.ApiService {
  ...
  @override
  _i6.Future<dynamic> sendRequest({required String? url}) =>
      (super.noSuchMethod(
        Invocation.method(
          #sendRequest,
          [],
  ...
  @override
  _i6.Future<List<_i9.TvSeriesSearchResult>> fetchTvSeries(
          {required String? url}) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchTvSeries,
  ...
  @override
  _i6.Future<List<_i9.TvSeriesSearchResult>> fetchTrandingTodayTvSeries() =>
      (super.noSuchMethod(
        Invocation.method(
...
class MockSearchqueryService extends _i1.Mock
    implements _i10.SearchqueryService {
  @override
  _i2.Logger get log => (super.noSuchMethod(
        Invocation.getter(#log),
        returnValue: _FakeLogger_0(
